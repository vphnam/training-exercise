...
import { Po } from 'src/app/services/interface/interface.service';
...
export class ShowPoComponent implements OnInit {
  constructor(private service: SharedService, private route: ActivatedRoute, 
    private modalService: NgbModal, public loaderService: LoaderService, public search: SearchfilterPipe) { 
  }
